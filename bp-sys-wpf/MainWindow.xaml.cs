...
namespace bp_sys_wpf
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Reset_for_a_game_Click(object sender, RoutedEventArgs e)
        {
            ...
            // image rest
            this.Hun_ban_review_1.Source = new BitmapImage(new Uri(GetFilePath("hunban", "null")));
            Front.front.Hun_ban_1.Source = new BitmapImage(new Uri(GetFilePath("hunban", "null")));
            this.Hun_ban_review_2.Source = new BitmapImage(new Uri(GetFilePath("hunban", "null")));
            Front.front.Hun_ban_2.Source = new BitmapImage(new Uri(GetFilePath("hunban", "null")));
            this.Hun_ban_review_3.Source = new BitmapImage(new Uri(GetFilePath("hunban", "null")));
            Front.front.Hun_ban_3.Source = new BitmapImage(new Uri(GetFilePath("hunban", "null")));
            this.Hun_pick_review.Source = new BitmapImage(new Uri(GetFilePath("hun", "null")));
            Front.front.Hun_pick.Source = new BitmapImage(new Uri(GetFilePath("hunhalf", "null")));
            Interlude.interlude.Hun.Source = new BitmapImage(new Uri(GetFilePath("hunBig", "null")));
            this.Sur_pick_1_preview.Source = new BitmapImage(new Uri(GetFilePath("sur", "null")));
            Front.front.Sur_pick_1.Source = new BitmapImage(new Uri(GetFilePath("surhalf", "null")));
            Interlude.interlude.Sur_1.Source = new BitmapImage(new Uri(GetFilePath("surBig", "null")));
            this.Sur_pick_2_preview.Source = new BitmapImage(new Uri(GetFilePath("sur", "null")));
            Front.front.Sur_pick_2.Source = new BitmapImage(new Uri(GetFilePath("surhalf", "null")));
            Interlude.interlude.Sur_2.Source = new BitmapImage(new Uri(GetFilePath("surBig", "null")));
            this.Sur_pick_3_preview.Source = new BitmapImage(new Uri(GetFilePath("sur", "null")));
            Front.front.Sur_pick_3.Source = new BitmapImage(new Uri(GetFilePath("surhalf", "null")));
            Interlude.interlude.Sur_3.Source = new BitmapImage(new Uri(GetFilePath("surBig", "null")));
            this.Sur_pick_4_preview.Source = new BitmapImage(new Uri(GetFilePath("sur", "null")));
            Front.front.Sur_pick_4.Source = new BitmapImage(new Uri(GetFilePath("surhalf", "null")));
            Interlude.interlude.Sur_4.Source = new BitmapImage(new Uri(GetFilePath("surBig", "null")));
            this.Sur_ban_review_1.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Sur_ban_1.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_ban_review_2.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Sur_ban_2.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_ban_review_3.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Sur_ban_3.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_ban_review_4.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Sur_ban_4.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_hole_ban_1_preview.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Hole_ban_1.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_hole_ban_2_preview.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Hole_ban_2.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_hole_ban_3_preview.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Hole_ban_3.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_hole_ban_4_preview.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Hole_ban_4.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_hole_ban_5_preview.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Hole_ban_5.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            this.Sur_hole_ban_6_preview.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
            Front.front.Hole_ban_6.Source = new BitmapImage(new Uri(GetFilePath("surban", "null")));
        }
        public MainWindow()
        {
            InitializeComponent();
