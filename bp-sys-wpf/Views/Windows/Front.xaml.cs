    ...
    public partial class Front : Window
    {
        ...
        public Front()
        {
            ...
            try
            {
                ...
                Global_no_ban_1.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_2.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_3.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_4.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_5.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_6.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_7.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_8.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
                Global_no_ban_9.Source = new BitmapImage(new Uri(getFilePath.GetAbsoluteFilePath("Resource/gui/no_Global_ban.png")));
